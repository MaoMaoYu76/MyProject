                    ...
                    if (errorCode === "auth/invalid-email") {
                        ...
                        if (email.endsWith("@gmail.com")) {
                            return <>
                                ...
                                <div className="alert-link" onClick={handleGoogle}><img src="/images/google.png" className="icon" /> 以Google繼續</div>
                            </>
                        } else {
                        ...
                        <div className="alert-link" onClick={handleCreate}><img src="/images/newauth.png" className="icon" /> 以此帳號密碼註冊</div>
                        </>
